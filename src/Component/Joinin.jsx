...
const Joinin = () => {
  ...
  <div className="hero-content flex-col lg:flex-row justify-between items-center gap-20">
    ...
    <div className=" lg:px-6 lg:py-8 md:px-8 ">
       ...
       <a href="">
      <Link to={'/'}> <p className="mt-3 text-xl  text-gray-600 dark:text-gray-200 hover:text-[#8064A2] hover:underline ">
            Sign In
        </p></Link>
       </a>
        ...
        <div className="mt-4">
            ...
            <progress className="progress w-40 bg-white" value={0} max="100"></progress>
        ...
        <div className="mt-6">
            <p className='text-xs mb-5'>By continuing, you agree to our <span className='font-bold'>Terms of Service</span> and <span className='font-bold'>Privacy Policy</span>.</p>
            <button className="w-full px-6 py-3 bg-[#8064A2] text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transhtmlForm  border-2 border-black  rounded-lg hover:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50">
            Agree and Continue
            </button>
        </div>
